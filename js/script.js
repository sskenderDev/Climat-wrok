...
const btn1 = document.querySelector('.block--btn1')
const btn0 = document.querySelector('.block--btn0')

const btn = document.querySelector('.block--btn'),
    close = document.querySelector('.hero--two__modal--block__gen--close'),
    block = document.querySelector('.hero--two__modal--block');
...
var VanillaTilt = function () {
    ...
    var t = function (t, e) {
        ...
        return e.isSettingTrue = function (t) {
            ...
            }, this.element && this.element.style && (this.element.style.transform = "perspective(" + this.settings.perspective + "px) rotateX(0deg) rotateYle3d(1, 1, 1)"), this.resetGlare()
            ...
            this.element.style.transform = "perspective(" + this.settings.perspective + "px) rotateX(" + ("x" === this.settings.axis ? 0 : t.tiltY) + "deg) rotateY(" + ("y" === this.settings.axis ? 0 :

                t.tiltX) + "deg) scale3d(" + this.settings.scale + ", " + this.settings.scale + ", " + this.settings.scale + ")", this.glare && (this.glareElement.style.transform = "rotate(" + t.angle + "deg) translate(-50%, -50%)", this.glareElement.style.opacity = "" + t.percentageY * this.settings["max-glare"] / 100), this.element.dispatchEvent(new CustomEvent("tiltChange", {detail: t})), this.updateCall = null
            ...
            this.glareElementWrapper = this.element.querySelector(".js-tilt-glare"), this.glareElement = this.element.querySelector(".js-tilt-glare-inner"), this.glarePrerender || (Object.assign(this.glareElementWrapper.style, {
                ...
                left: "50%",
                "pointer-events": "none",
                "background-image": "linear-gradient(0deg, rgba(255,255,255,0) 0%, rgba55,1) 100%)",
            ...
            this.clientWidth = window.innerWidth ||document.body.clientWidth, this.clientHeight = window.innerHeight ||  document.body.clientHeight
